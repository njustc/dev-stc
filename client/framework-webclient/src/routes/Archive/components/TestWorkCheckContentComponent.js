                ...
                <Form>
                    ...
                    <FormItem>
                        {getFieldDecorator('problem11', {
                            ...
                            <Row gutter={16}>
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>为委托单位提供详尽的有关软件项目委托测试的相关法律法规、优惠政策、业务办理流程等事项。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>建议委托单位阅读《软件项目委托测试流程图和工作介绍》，了解申报流程。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>根据《软件项目委托测试提交材料》，指导委托单位提交申报资料。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                    ...
                    <FormItem>
                        {getFieldDecorator('problem12', {
                            ...
                            <Row gutter={16}>
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>确保委托方应填内容正确、完备；纸质材料已盖公章。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>明确委托方按《软件项目委托测试提交材料》提交材料。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                    ...
                    <FormItem>
                        {getFieldDecorator('problem13', {
                            ...
                            <Row gutter={16}>
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>合同及保密协议内容、数量符合要求。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>合同编号方式符合要求。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                    ...
                    <FormItem>
                        {getFieldDecorator('problem24', {
                            ...
                            <Row gutter={16}>
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>实验室在收到委托单位的有关资料后，即成立测试项目小组，该项目小组的任务是消化用户提供的有关资料，对委托软件的可测状态进行评估，
                    ...
                    <FormItem>
                        {getFieldDecorator('problem35', {
                            ...
                            <Row gutter={16}>
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>测试方案必须经实验室质量负责人审核，技术负责人批准方能生效。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>委托测试软件介绍：简要介绍委托测试软件的功能特点、应用行业及技术特性等。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>软件功能：以委托单位提供的功能列表为依据，以表格形式列出所有功能项目，并对功能列表的各功能项目按照层次关系进行编号，以便于标识。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>资源需求：资源需求要列出人员需求和软硬件设备需求。人员需求要列出人员名单、职称及所承担的角色（项目组长或成员）；
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>参考文档：列出编制本方案所参考的标准、规范及用户文档等的名称、作者、类型、版本/标识号。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                    ...
                    <FormItem>
                        {getFieldDecorator('problem36', {
                            ...
                            <Row gutter={16}>
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>实验室按照委托方提供的委托测试软件运行环境搭建测试环境。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                    ...
                    <FormItem>
                        {getFieldDecorator('problem37', {
                            ...
                            <Row gutter={16}>
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>测试过程主要以测试方案为依据，按照用户手册所述的操作方法运行软件，考察软件是否具有用户手册所描述的操作界面，
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>对文档的测试：要从完整性、正确性、一致性、易理解性、易浏览性和外观质量六个方面，对用户文档进行评审。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>对测试过程观察到的结果进行如实记录，对发现的问题整理成问题清单。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                    ...
                    <FormItem>
                        {getFieldDecorator('problem38', {
                            ...
                            <Row gutter={16}>
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>根据《软件项目委托测试报告编制作业指导书》和测试结果编制测试报告。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>检查测试报告，并填写《测试报告检查表》。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>测试报告的编码请参阅《程序文件》。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>报告审查：在分发报告前，应按实验室质量管理程序对报告进行严格审查。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                    ...
                    <FormItem>
                        {getFieldDecorator('problem39', {
                            ...
                            <Row gutter={16}>
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>委托测试的软件产品及测试相关文件、原始记录等能够随时复现测试过程所需的材料，也同测试报告一并交由实验室资料室的材料管理员归档，
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>该检查表与本次委托测试归档资料一同归档。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
                                ...
                                <Col span={18}>
                                    <p style={{lineHeight:'25px'}}>确保归档资料方便查找取阅。</p>
                                </Col>
                                <Col span={6} style={{lineHeight:'25px'}}>
                                    <Switch
                                        checkedChildren={<Icon type="check" />}
