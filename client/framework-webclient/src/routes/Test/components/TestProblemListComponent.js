...
export default class TestProblemListComponent extends Component {
    constructor(props) {
        super(props);
    }
    ...
    static propTypes = {
        ...
        getTestProblemList: PropTypes.func,
        //newContract: PropTypes.func,
        //enableNew: PropTypes.bool,
    };

    componentDidMount() {
        this.props.getTestProblemList();
    }
    ...
    render() {
        return (
            <div>
                <h3 style={{ marginBottom: 16 }}>测试问题清单列表</h3>
                <InputGroup>
                    <Col span={3}>
                        <Select defaultValue="搜索测试问题清单ID" onSelect={this.onSelect}>
                            <Option value="id">搜索测试问题清单ID</Option>
                    ...
                    {/*this.props.enableNew*/0 ?
                        <Col span={2}>
                            <Button type="primary" onClick={this.props.newConsign}><Icon type="plus-circle-o" />新建测试问题清单</Button>
                        </Col>
                        : <Col span={2}></Col>}
                </InputGroup>
                <br />
