...
export default class TestRecordListComponent extends Component {
    ...
    static propTypes = {
        ...
        getTestRecordList: PropTypes.func,
        //newContract: PropTypes.func,
        //enableNew: PropTypes.bool,
    };

    componentDidMount() {
        this.props.getTestRecordList();
    }
    ...
    render() {
        return (
            <div>
                <h3 style={{ marginBottom: 16 }}>测试记录列表</h3>
                <InputGroup>
                    <Col span={3}>
                        <Select defaultValue="搜索测试记录ID" onSelect={this.onSelect}>
                            <Option value="id">搜索测试记录ID</Option>
