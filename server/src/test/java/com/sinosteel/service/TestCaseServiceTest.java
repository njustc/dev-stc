...
public class TestCaseServiceTest {
    ...
    public void Test_queryTestCases(){
        System.out.println("测试工作人员获取测试样例");
        try {
            JSON result = testCaseService.queryTestCases(testUser);
    ...
    @Test
    public void test_SE(){
        System.out.println("=====customer1 新建一个测试样例=====");
        JSONObject TestCase = new JSONObject();
        TestCase.put("testcase", "这是testUser测试中新建的一个测试样例");
