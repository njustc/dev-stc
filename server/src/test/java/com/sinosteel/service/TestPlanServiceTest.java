...
public class TestPlanServiceTest {
    ...
    @Test
    public void test_SE(){
        System.out.println("=====testUser 新建一个测试计划=====");
        ...
        try {
            ...
            //test_addTestPlan
            JSONObject jsonResult = testPlanService.addTestPlan(TestPlan, null, testUser);
            ...
            String edit_contents = "这是testUser在测试中修改的测试计划";
            jsonTestPlan.put(edit_object,edit_contents );
            jsonTestPlan = testPlanService.editTestPlan(jsonTestPlan, null, testUser);
