...
import com.njustc.framework.utils.spring.SpringUtil;
import com.njustc.framework.utils.string.StringUtil;
import com.njustc.service.AuthService;
...
public class AuthorizationAspect {
    ...
    //TODO: Needs Organizition and api: userService->getOrganizationIdsByUserID(String id)
    @Around("@annotation(com.njustc.framework.core.auth.RequiresAuthorization) && @annotation(authorizationAnnotation)")
    ...
    private int filterData(JSONArray dataJsonArray, User requestUser, AuthorizationScope queryScope, AuthorizationScope editScope, AuthorizationScope deleteScope)
    {
        ...
        JSONObject requestUserJson = JSONObject.parseObject(JSONObject.toJSONString(requestUser));
