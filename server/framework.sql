...
CREATE TABLE `tbl_sys_testreportchecks`(
  ...
  `SOFTWARENAME`text COLLATE utf8_bin DEFAULT NULL,
  `CLIENTCOMPANY`text COLLATE utf8_bin DEFAULT NULL,
  `CHECKBODY`text COLLATE utf8_bin DEFAULT NULL,
  `CHECKMAN`text COLLATE utf8_bin DEFAULT NULL,
  `CHECKDATA`text COLLATE utf8_bin DEFAULT NULL
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `tbl_sys_testworkchecks`(
  ...
  `VERSION` text COLLATE utf8_bin DEFAULT NULL,
  `CLIENT` text COLLATE utf8_bin DEFAULT NULL,
  `STARTTIME` text COLLATE utf8_bin DEFAULT NULL,
  `FCENDTIME` text COLLATE utf8_bin DEFAULT NULL,
  `TESTWORKDER` text COLLATE utf8_bin DEFAULT NULL,
  `ACENDTIME` text COLLATE utf8_bin DEFAULT NULL,
  `CHECKBAODY` text COLLATE utf8_bin DEFAULT NULL
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
