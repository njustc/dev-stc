...
--  修改表项，
--
  `FUNCTEST_MODE_ID` text COLLATE utf8_bin DEFAULT NULL,
  `FUNCTEST_MODE_NAME` text COLLATE utf8_bin DEFAULT NULL,
  `FUNCTEST_MODE_INFO` text COLLATE utf8_bin DEFAULT NULL,
...
--
  ...
  `TESTREPO_FNAMEY`text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_FVERSION`text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_FCOMPANY`text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_FTESTTYPE`text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_FTIME`text COLLATE utf8_bin DEFAULT NULL,
  ...
  `TESTREPO_TESTTYPE` text COLLATE utf8_bin DEFAULT NULL,
  ...
  `TESTREPO_HTYPE` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_HNAME` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_HCONF` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_HNUM` text COLLATE utf8_bin DEFAULT NULL,

  `TESTREPO_STYPE` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_SNAME` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_SVERSION` text COLLATE utf8_bin DEFAULT NULL,

  `TESTREPO_WEBENV` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_TESTRELY` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_TESTREFER` text COLLATE utf8_bin DEFAULT NULL,

  `TESTREPO_FUNMODE` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_FUNCREQUIRE` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_FUNCRESULT` text COLLATE utf8_bin DEFAULT NULL,

  `TESTREPO_EFFTYPE` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_EFFINFO` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_EFFRESULT` text COLLATE utf8_bin DEFAULT NULL,

  `TESTREPO_TRANSTYPE` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_TRANSINFO` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_TRANSRESULT` text COLLATE utf8_bin DEFAULT NULL,

  `TESTREPO_USETYPE` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_USEINFO` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_USERESULT` text COLLATE utf8_bin DEFAULT NULL,

  `TESTREPO_RELYTYPE` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_RELYINFO` text COLLATE utf8_bin DEFAULT NULL,
  `TESTREPO_RELYRESULT` text COLLATE utf8_bin DEFAULT NULL,
...
--
  ...
  `TRC_SOFTNAME` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_CLIENTNAME` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT1` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT2` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT3` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT4` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT5` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT6` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT7` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT8` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT9` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT10` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT11_1` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT11_2` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT11_3` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_RESULT12` text COLLATE utf8_bin DEFAULT NULL,

  `TRC_AUDITOR` text COLLATE utf8_bin DEFAULT NULL,
  `TRC_TIME` text COLLATE utf8_bin DEFAULT NULL
